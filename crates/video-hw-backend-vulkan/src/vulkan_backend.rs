        ...
        Ok(inspection) => {
            message.push_str(&format!(
                ...
                probe_av1_decode_session_parameters_for_bitstream(bitstream)
                    .map(|probe| {
                        format!(
                            "ready(coded={}x{}, picture_format={:?}, offset_align={}, size_align={}, upload_bytes={}, decode_image_layers={}, decode_image_barrier_layers={}, command_record_decodes={}, command_buffer_recorded={}, command_buffer_submitted={}, session_memory_count={}, session_memory_bound={}, session_memory_total={}, session_memory_max_align={})",
                            probe.coded_width,
                            probe.coded_height,
