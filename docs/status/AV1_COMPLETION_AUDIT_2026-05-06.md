...
| Vulkan AV1 decode | `crates/video-hw-backend-vulkan/src/vulkan_av1_decode.rs`; `output/vulkan-av1-psnr/vulkan-av1-psnr-1778067206093.md`; `output/vulkan-av1-psnr/vulkan-av1-psnr-1778067206134.md`; `output/vulkan-av1-psnr/vulkan-av1-psnr-1778074633347.md`; `output/vulkan-av1-psnr/vulkan-av1-psnr-1778075814861.md`; `output/vulkan-av1-psnr/vulkan-av1-psnr-1778075801683.md`; `output/vulkan-av1-psnr/vulkan-av1-psnr-1778076508703.md`; `output/benchmark-vulkan-av1-1778068460.md`; `output/benchmark-vulkan-av1-1778068469.md`; `output/benchmark-vulkan-av1-1778076509.md` | Generated keyframe-only OBU/fMP4, short GOP OBU, long-GOP OBU, and long-GOP fMP4 decode on NVIDIA pass PSNR; integrated Vulkan benchmark `--verify` now records a passing PSNR row for generated GOP30 input using the measured `decode_to_yuv` binary | Partial |
