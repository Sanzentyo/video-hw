...
| Vulkan AV1 inter-frame/GOP replay | `scripts/check_vulkan_av1_psnr.rs --gop-size 30`; `scripts/inspect_av1_frame_types.rs`; reports `output/vulkan-av1-psnr/vulkan-av1-psnr-1778068076063.md`, `output/vulkan-av1-psnr/vulkan-av1-psnr-1778068145633.md`, `output/av1-frame-types/av1-frame-types-1778070802078.md`, `output/av1-frame-types/av1-frame-types-1778070805328.md` | The gap is explicitly detected: generated GOP input has `frame_type=1` after the keyframe and current Vulkan AV1 decode rejects it | Not done |
