...
| Vulkan AV1 inter-frame/GOP replay | `scripts/check_vulkan_av1_psnr.rs --gop-size 2`; `scripts/check_vulkan_av1_psnr.rs --gop-size 30`; `scripts/check_vulkan_av1_psnr.rs --gop-size 30 --lag-in-frames 25`; reports `output/vulkan-av1-psnr/vulkan-av1-psnr-1778074489393.md`, `output/vulkan-av1-psnr/vulkan-av1-psnr-1778074616975.md`, `output/vulkan-av1-psnr/vulkan-av1-psnr-1778074633347.md`, `output/vulkan-av1-psnr/vulkan-av1-psnr-1778075814861.md`, `output/vulkan-av1-psnr/vulkan-av1-psnr-1778075801683.md`, `output/vulkan-av1-psnr/vulkan-av1-psnr-1778077832379.md`; `output/benchmark-vulkan-av1-1778077834.md` | Generated GOP replay with `lag-in-frames 0` passes with `psnr_y_min=inf`; bounded-DPB replay now avoids unbounded reference slot indexes. `lag-in-frames 25` creates alt-ref/show-existing input; metadata decode command submit passes and reports 16 displayed frames, but PSNR/NV12 readback still fails because the current post-submit DPB readback cannot return all displayed frames when 16 display frames require 17 decode commands. | Partial |
