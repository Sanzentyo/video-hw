...
blocker is not only the repository sample's parameter-set shape. More complete
HEVC picture resource / reference slot wiring is still required before enabling
